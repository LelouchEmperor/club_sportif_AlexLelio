...
class CategorieController {
    ...
    public function showCategorie($categorieId) {
        ...
        if (!$categorie) {
            echo "Aucune catégorie n'a été trouvée avec l'identifiant $categorieId";
            return;
        }
    
        // Récupérer les licenciés liés à la catégorie
        $licencies = $this->categorieDAO->getLicenciesByCategorie($categorieId);
    
        include('view/Categorie/showCategorie.php');
    }
    ...
    public function showCategorieContact($categorieId) {
        $categorie = $this->categorieDAO->getById($categorieId);
        ...
        // Récupérer les contacts liés à la catégorie
        $contacts = $this->categorieDAO->getContactsByCategorie($categorieId);
    
        include('view/Categorie/showCategorieContact.php');
    }
