        ...
        <ul>
            <?php foreach ($categories as $categorie): ?>
                <li>
                    ...
                    <a href="index.php?page=categorie&action=showCategorie&id=<?php echo $categorie->getId(); ?>"class="btn btn-primary btn-sm" >Afficher licenciés</a>
                    <a href="index.php?page=categorie&action=showCategorieContact&id=<?php echo $categorie->getId(); ?>"class="btn btn-success btn-sm" >Afficher Contact</a>
