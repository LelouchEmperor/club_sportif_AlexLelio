    ...
    <ul>
        <?php foreach ($mails as $mail): ?>
            <li>
                ...
                <a href="index.php?page=mailcontact&action=deleteMail&id=<?php echo $mail->getId(); ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce mail ?')">Supprimer</a>
            </li>
        <?php endforeach; ?>
    </ul>
</body>
